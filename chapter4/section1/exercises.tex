...
\begin{proof}
  ...
  Since $D'$ is effective, the only pole of $f$ is $P$ of order at most $n$.
\end{proof}
...
\begin{proof} $ $ \vspace{0pt}
  \begin{enumerate} [label=(\alph*), leftmargin=0cm]
    ...
    \item Let $X$ be an irreducible and nonsingular divisor of type $(g + 1, 2)$ on $\PP^1 \times \PP^1$ given by a closed embedding $j : X \to \PP^1 \times \PP^1$, and let $\pi : \PP^1 \times \PP^1 \to \PP^1$ be the projection map onto its first argument.
