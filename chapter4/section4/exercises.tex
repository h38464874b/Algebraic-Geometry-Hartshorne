...
\begin{enumerate} [label=\textbf{\arabic*.}, leftmargin=0em]
      ...
      \item[\textbf{3.}] Let the elliptic curve $X$ be embedded in $\PP^2$ so as to have the equation $y^2 = x(x - 1)(x - \lambda)$.
            ...
            \begin{proof}
                  Embedding of $X$ in $\PP^2$ given by linear system $|3P_0|$.
            \end{proof}
      ...
      \item[\textbf{7.}] \textit{The Dual of a Morphism.} Let $X$ and $X'$ be elliptic curves over $k$, with base points $P_0, P_0'$.
            ...
            \begin{proof} $ $ \vspace{0pt}
                  \begin{itemize} [leftmargin=0cm]
                        \item[(a)] Since $f^*$ maps $\pic(X')^\circ$ to $\pic(X)^\circ$, 
                  \end{itemize}
            \end{proof}
      ...
      \item[\textbf{9.}] We say two elliptic curves $X, X'$ are \textit{isogenous} if there is a finite morphism $f : X \to X'$.
            ...
            \begin{proof} $ $ \vspace{0pt}
                  \begin{itemize} [leftmargin=0cm]
                        \item[(a)] The only nontrivial axiom of equivalence relations to check is reflexivity, which is taken care of by (Ex. 4.7a).
                  \end{itemize}
            \end{proof}
      ...
      \item[\textbf{22.}] If $X \to \A_C^1$ is a family of elliptic curves having a section, show that the family is trivial.
            ...
            \begin{proof}
                  Let $\sigma : \A_C^1 \to X$ be a section.
            \end{proof}
