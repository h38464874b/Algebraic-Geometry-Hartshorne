...
\begin{enumerate} [label=\textbf{\arabic*.}, leftmargin=0em]
  ...
  \item Use (2.5.3) to show that $\PP^n$ is simply connected.
        ...
        \begin{proof}
          ...
          It suffices to show $f$ is one-to-one.
          Let $y$ be any closed point in  $\PP^n$, and let $L = \PP^{1}$ be any line in $\PP^n$ containing $y$.
          The restriction $f : f^{-1}(L) \to L$, obtained by taking the base change $L \hookrightarrow \PP^1$, is is an étale covering, so $f^{-1}(L)$ is a disjoint union of rational curves (2.5.3).
        \end{proof}
  ...
  \item \textit{Classification of Curves of Genus 2.} Fix an algebraically closed field $k$ of characteristic $\neq 2$.
        ...
        \begin{proof} $ $ \vspace{0pt}
          \begin{enumerate} [leftmargin=0cm]
            ...
            \item $B = k[x, z]/(z^2 - g(x))$ and $g(x) = (x - \alpha_1) \cdots (x - \alpha_6)$, and $f$ is the projection morphism onto the $x$-axis.
            By (II, 8.3A), we have
            \begin{equation*}
              \Omega_{B / k} \cong (B \dd x \oplus B \dd z) / (g'(x) \dd x + 2z \dd z).
            \end{equation*}
            Let $P = (x', z')$ be a closed point on $X$.
            ...
            Since $\dd x $ is a local parameter of $\PP^1$, we see that $P$ is ramified if and only if $z' = 0$, with $\dd x / \dd z = - 2 z / g'(z)$.
            Moreoever, $v_P( \dd x / \dd z) = 1$, so the ramification index is 2 (2.2), and the degree of the ramification divisor is 6.
            By Hurwitz's theorem, $g(X) = 2$.
