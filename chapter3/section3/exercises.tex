...
We have $U = \bigcup_{i = 1}^r U_i$, where $U_i$ is the distinguished open set in $X$ associated to $f_i \in A$.
In the category of open sets, unions can be expressed as colmits.
In particular, $U = \varinjlim_i U_i$.
By passing to a direct system of 
\begin{align*}
  \Gamma(U, \widetilde{M}) & = \Gamma(\varinjlim_i U_i, \widetilde{M}) \\
  & \cong \varinjlim_i \Gamma(U_i, \widetilde{M}) \\
  & \cong \varinjlim_i M_{f_i}.
\end{align*}
