...
\begin{enumerate} [label=\textbf{\arabic*.}, leftmargin=0em]
    ...
    \item \begin{itemize}
          ...
          \begin{proof} $ $ \vspace{0pt}
              \begin{itemize} [leftmargin=0cm]
                  \item[(a)] By (Ex. 1.3a), $C^2 = -C.K - 2$, by (1.3) $C.K = d - 4$ because $C$ is a straight line, and $\fO_X(K) = \fO_X(d - 4)$.
                  Hence, $C^2 = 2 - d$.

                  \item[(b)] $X$ corresponds to a section of $\fO_{\PP^3}(d)$.
              \end{itemize}
          \end{proof}
    ...
    \item \begin{itemize}
          ...
          \begin{proof} $ $ \vspace{0pt}
              \begin{itemize} [leftmargin=0cm]
                  ...
                  \item[(b)] We have $K = p_1^*K_C + p_2^*K_{C'}$, so put $D = p_1^*K_C$ and $D' = p_2^*K_{C'}$.
                   Then $\Supp(D) = \Supp(K_C) \times C'$, and similarly for $D'$, which by (1.3) implies $$D.D' = \deg{K_C} \cdot \deg{K_{C'}} = 4(g - 1)(g' - 1).$$
                    Since $K = D + D'$, it suffices to show $D^2 = 0$.
              \end{itemize}
          \end{proof}
    ...
    \item \begin{itemize}
          ...
          \begin{proof} $ $ \vspace{0pt}
              \begin{itemize} [leftmargin=0cm]
                  ...
                  \item[(b)] By (1.5), we have $2g - 2 = l^2 + l.K$
              \end{itemize}
          \end{proof}
