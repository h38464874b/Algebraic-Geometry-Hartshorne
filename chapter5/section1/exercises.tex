...
\begin{enumerate} [label=\textbf{\arabic*.}, leftmargin=0em]
    ...
    \item Let $H$ be a very ample divisor on the surface $X$, corresponding to a projective embedding $X \subseteq \PP^N$.
          ...
          \begin{proof}
              ...
              \begin{equation*}
                  b = \frac{1}{2}H^2 + 1 - \pi.
              \end{equation*}
              If $C$ is any curve in $X$, then the degree of $C$ in $\PP^N$ is just the degree of $\fO_X(H) \otimes \fO_C$ as a line bundle on $C$, which is equal to $C.H$ by (1.3).
          \end{proof}
    ...
    \item \begin{itemize}
          ...
          \begin{proof} $ $ \vspace{0pt}
              \begin{itemize} [leftmargin=0cm]
                  ...
                  \item[(b)] Fix an integer $d > 0$, let $L$ be any line in $\PP^3$ with ideal sheaf $\fI$.
                        Consider the linear system $\goth{d}$ on $\PP^3$ associated to $\cH^0(\PP^3, \fI(d))$.
                        It has base-locus equal to $L$, and by Bertini's theorem (III, 10.9) (III, 10.9.1) (III, 10.9.2) (III, Ex. 11.3), a general member of $\goth{d}$ is connected and can have singularities only at the base points.
                        Now, 
              \end{itemize}
          \end{proof}
          ...
          \begin{proof} $ $ \vspace{0pt}
              \begin{itemize} [leftmargin=0cm]
                  ...
                  \item[(b)] By (II, Ex. 8.3), there is an isomorphism $\omega_{X} \cong p_1^*\omega_C \otimes p_2^*\omega_{C'}$.
                        In particular, if $K_C$ (resp. $K_{C'}$) is a canonical divisor of $C$ (resp. $C'$), then $p_1^*K_C + p_2^*K_{C'}$ is a canonical divisor of $X$.
                        Denote $D = p_1^*K_C$ and $D' = p_2^*K_{C'}$.
                        The support of $D$ consists of $2g - 2$ copies of $C'$ which are the fibres of the points in $K_C$ with respect to $p_1 : X \to C$.
                        It follows that
                        \begin{equation*}
                            D.D' = (\deg{K_C}) \cdot (\deg{K_{C'}}) = 4(g - 1)(g' - 1).
                        \end{equation*}
                        Also, for any finite set of points in $C$, there exists a canonical divisor with disjoint support.
                        The intersection pairing only depends on the linear equivalence class, so we have $D^2 = 0$.
    ...
    \item \textit{Algebraic Equivalence of Divisors.} Let $X$ be a surface.
          ...
          \begin{proof} $ $ \vspace{0pt}
              \begin{itemize} [leftmargin=0cm]
                  ...
                  \item[(b)] We divide the problem into steps by successively proving more general cases, i.e., when $D$ is an (1) irreducible curve, (2) effective divisor, and (3) arbitrary divisor.

                        (1) By definition, there exists a rational function $f \in K(X)^*$ such that $D - D' = (f)$.
                        On an open subset $U \subset X$, let $g, g'$ be locally defining equations of $D, D'$ such that $g = fg'$.
                        The divisors associated to $h = (1 - t)g + tg'$ for each $t \in \A^1$ gives a family of divisors on $U \times \A^1$.
                        Covering $C$ by open subsets and patching local equations give an effective Cartier divisor $E$ on $X \times T$, flat over $T$, and $E_0 = D, E_1 = D'$.
                        Hence, if $D$ and $D'$ are linearly equivalent irreducible curves in $X$, then they are algebraically equivalent.
    ...
    \item \begin{itemize}
          ...
          \begin{proof} $ $ \vspace{0pt}
              \begin{itemize} [leftmargin=0cm]
                  \item[(a)] Before we prove the statement, let us look at an example first.
                        Consider the quadric surface $Q = \PP^1 \times \PP^1$ with $H$ divisor of type $(1, 1)$, which gives the standard embedding into $\PP^3$.
                        If $D$ be a divisor of type $(a, b)$, then by (1.4.3), the left-hand side is equal to $2(a^2 + b^2)$, while the right-hand side is $(a + b)^2$ (IV, 6.4.1) (Ex. 1), so the inequality holds.

                        Now, let $D$ be any divisor, and let $E$ be any irreducible curve in $X$.
                        By replacing $H$ with $mH$ for some $m \gg 0$ if necessary, we may assume that $H$ is very ample.
                        The hypothesis of (1.2) is satisfied, so further assume $H$ is irreducible, nonsingular, and meets $E$ and each irreducible component of $D$ transversally.

                        We will show that the inequality holds for $D$ if and only if it holds for $D + E$ (IV, 1.3).
                        Plugging in $D + E$ into above simplifies to
                        \begin{equation*}
                            (D^2)(H^2) + 2(D.C)(H^2) \leq (D.E)^2 + 2(D.E)(C.E),
                        \end{equation*}
                        so it is enough to show
                        \begin{equation*}
                            (D.E)(H^2) \leq (D.H)(E.H)
                        \end{equation*}
                        for any divisor $D$ and irreducible curve $E$.
                        Here, we can apply the reasoning above again, and for the last time further reduce to the case $D$ is also an irreducible curve.
